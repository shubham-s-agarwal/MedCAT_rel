...
class General(MixingConfig, BaseModel):
    ...
    labels2idx: Dict = {'Other': 0, 'NonRel': 1, 'ADE-Drug': 2, 'Reason-Drug': 3, 'Strength-Drug': 4, 'Duration-Drug': 5}
    # {'Reason-Drug':0, 'Duration-Drug' :1, 'ADE-Drug' :2, 'Dosage-Drug': 3, 'Strength-Drug' :4, 'NonRel' :5, 'Route-Drug' :6, 'Frequency-Drug' :7, 'Form-Drug' :8}
    idx2labels: Dict = {0: 'Other', 1: 'NonRel', 2: 'ADE-Drug', 3: 'Reason-Drug', 4: 'Strength-Drug', 5: 'Duration-Drug'}
    # {0: 'Reason-Drug', 1: 'Duration-Drug', 2: 'ADE-Drug', 3: 'Dosage-Drug', 4: 'Strength-Drug', 5: 'NonRel', 6: 'Route-Drug', 7: 'Frequency-Drug', 8: 'Form-Drug'}
