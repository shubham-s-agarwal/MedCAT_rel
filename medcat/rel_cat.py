    ...
    def train(self, export_data_path:str = "", train_csv_path:str = "", test_csv_path:str = "", checkpoint_path: str = "./"):
        ...
        for epoch in range(0, _epochs):
            ...
            for i, data in enumerate(train_dataloader, 0):
                ...
                print("Accuracy:",accuracy_score(labels.squeeze(1), np.argmax(classification_logits.detach().cpu().numpy(), axis=1)))
                print("F1-score",f1_score(labels.squeeze(1), np.argmax(classification_logits.detach().cpu().numpy(), axis=1),average='weighted'))
            pbar.close()
